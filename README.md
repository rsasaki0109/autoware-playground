...
The current benchmark × experiment table — auto-regenerated by CI on every push to `main` from real `ros2 bag play` runs plus committed baselines — is at [`reports/leaderboard.md`](reports/leaderboard.md).

## CLI (extras)

```text
apg leaderboard [--format text|markdown|json]   # benchmark x experiment table
...
- ✅ CI-generated leaderboard committed to `reports/leaderboard.md`
